  ...
  return (
    <main className="min-h-screen bg-[#F5F2ED] text-[#8B6B4A]"
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-8 md:px-20 py-5">
        <div className="flex gap-10 text-lg font-medium drop-shadow-md" style={{ color: "#8B6B4A" }}>
          {[
            { label: "Bio", href: "#bio" },
        ...
        <div className="px-8 md:px-20 max-w-5xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-4 gap-4">
            <a href="https://open.spotify.com/artist/2nyS5xoo0whI3q74gsRmHL" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#1DB954] text-black text-sm font-semibold hover:opacity-90 transition">
            ...
            <a href="https://music.apple.com/us/artist/michael-cantor/1631765548" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#fc3c44] text-white text-sm font-semibold hover:opacity-90 transition">
              Apple Music
            </a>
            <a href="https://youtube.com/channel/UCHLDDkR-qNPVgtFQFGk4aDw" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#FF0000] text-white text-sm font-semibold hover:opacity-90 transition">
              YouTube
            </a>
            <a href="https://tidal.com/artist/32899611/u" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#000000] text-white text-sm font-semibold hover:opacity-90 transition">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* ── SOCIALS ── */}
      <section id="socials" className="py-24 px-8 md:px-20 max-w-5xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold mb-12">Follow Along</h2>
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-4 border border-[#D8D4CE] rounded-2xl p-10 hover:border-[var(--accent)] transition-colors text-center">
              <div className="w-14 h-14 rounded-full bg-[#E8E4DE] flex items-center justify-center transition-transform group-hover:scale-110 duration-300"
